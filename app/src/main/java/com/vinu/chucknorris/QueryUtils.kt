...
public class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return a list of {@link JokeObject} objects.
     */
...
//        }
        ...
        ArrayList<String> jokes = extractFeatureFromJson(jsonResponse);
    ...
    /**
     * Return a list of {@link JokeObject} objects that has been built up from
     * parsing the given JSON response.
     */
    public static ArrayList<String> extractFeatureFromJson(String jokeJSON) {
        ...
        try {
            ...
            JSONObject jsonObj = new JSONObject(jokeJSON);

            // Getting JSON Array node
            JSONArray valueArray = jsonObj.getJSONArray("value");

            // looping through All jokeArray
            for (int i = 0; i < valueArray.length(); i++) {
                JSONObject currentJoke = valueArray.getJSONObject(i);
                String jokeString = currentJoke.getString("joke");
